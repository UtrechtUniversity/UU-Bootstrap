import{a as m,r as p,q as r,o as a,b as n,e as s,w as t,u as i,F as _,m as b,i as o,f as e,v as l,t as f}from"./entry-2055ce85.mjs";import{_ as g}from"./sidebar-0a9162e8.mjs";import{U as v}from"./uu-layout-nav-05f91fab.mjs";const y={class:"uu-content"},w=o(" Hero | UU Layout | Portaldev Bootstrap theme docs "),U=e("div",{class:"uu-hero"},[e("h1",null,"UU Layout Hero")],-1),x=o(" Sidebar "),H=e("h2",{class:"mt-3"}," Variables ",-1),k=e("pre",null,`$uu-hero-bg:          $yellow;
$uu-hero-color:       color-contrast($uu-hero-bg);
$uu-hero-padding-y:   1rem;
$uu-hero-font-weight: 400;
                    `,-1),L=e("p",null," The UU Layout Hero is basically a colored banner. It's very simple, but also very versatile. ",-1),T=e("p",null,[o(" Once again, it's internal layouting is similar to "),e("code",null,".row"),o(", thus you can customize to your hart's content. ")],-1),$=e("p",null," Some examples of how you can use this element are at the bottom of this page. ",-1),B={class:"uu-content"},C=["innerHTML"],I={class:"uu-container"},A=m({__name:"hero",setup(N){const c=p([`<header class="uu-hero">
    <h1>Basic usage</h1>
...
</div>`]);return(S,V)=>{const d=r("Title"),h=r("Head");return a(),n("div",y,[s(h,null,{default:t(()=>[s(d,null,{default:t(()=>[w]),_:1})]),_:1}),U,s(i(g),{placement:"right"},{"sidebar-button":t(()=>[x]),sidebar:t(()=>[s(v),H,s(i(l),{language:"scss",class:"w-100"},{default:t(()=>[k]),_:1})]),default:t(()=>[L,T,$]),_:1}),(a(!0),n(_,null,b(c.value,u=>(a(),n("div",B,[e("div",{class:"uu-content",innerHTML:u},null,8,C),e("div",I,[s(i(l),{language:"html",class:"w-100"},{default:t(()=>[o(f(u),1)]),_:2},1024)])]))),256))])}}});export{A as default};
