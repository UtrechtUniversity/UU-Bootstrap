import{a as m,r as p,b as r,o as a,e as n,f as s,w as t,u as i,F as _,s as b,j as o,h as e,v as l,t as f}from"./entry.3abd7c6f.js";import{_ as g}from"./sidebar.vue_vue_type_script_setup_true_lang.193f980a.js";import v from"./uu-layout-nav.778605d5.js";const y={class:"uu-content"},w=o(" Hero | UU Layout | Portaldev Bootstrap theme docs "),x=e("div",{class:"uu-hero"},[e("h1",null,"UU Layout Hero")],-1),U=o(" Sidebar "),H=e("h2",{class:"mt-3"}," Variables ",-1),k=e("pre",null,`$uu-hero-bg:          $yellow;
...
</div>`]);return(N,S)=>{const d=r("Title"),h=r("Head");return a(),n("div",y,[s(h,null,{default:t(()=>[s(d,null,{default:t(()=>[w]),_:1})]),_:1}),x,s(i(g),{placement:"right"},{"sidebar-button":t(()=>[U]),sidebar:t(()=>[s(v),H,s(i(l),{language:"scss",class:"w-100"},{default:t(()=>[k]),_:1})]),default:t(()=>[L,T,$]),_:1}),(a(!0),n(_,null,b(c.value,u=>(a(),n("div",j,[e("div",{class:"uu-content",innerHTML:u},null,8,B),e("div",C,[s(i(l),{language:"html",class:"w-100"},{default:t(()=>[o(f(u),1)]),_:2},1024)])]))),256))])}}});export{A as default};
