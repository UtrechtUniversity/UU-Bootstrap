...
<template>
    <div class="uu-content">
        ...
        <Sidebar placement="right" :sticky-sidebar="true" :mobile-sticky-sidebar="true">
            ...
            <p>
                This library provides a set of classes/components that allow you to easily create a
                page that passes as a UU website. This page will cover the basics, with some larger
                sub-components having their own page.
            </p>
            <p>
                You can use the rest of this library without UU layout if you just want the
                component stylings. However, all components under the UU layout section (identified
                by the
...
$uu-border-color-dark: $gray-800;
                ...
                <p>
                    Container width refers to the <i>maximum width</i> of the container. The border
                    variables set color to various borders used in a UU layout.
                </p>
            </template>
            ...
            <p>
                ...
                also acts as the namespace for all components in the UU layout. Thus, all
                <code>uu-</code> prefixed classes only work inside one of these containers.
            </p>
        </Sidebar>
        <Sidebar placement="right" mobile-placement="bottom" :mobile-sticky-sidebar="true">
            <template #sidebar-button> Variables </template>
            ...
            <p>
                This project provides two distinct <em>styles</em> of header: classic and unified.
                The classic style implements the most common style found on UU sites. The unified
                style is a smaller alternative, used mostly by new internal 'tool' websites.
            </p>
            <p>
                By default, this documentation uses the 'classic' header, but the classic can be
                previewed by selecting it under 'theme settings'.
            </p>
        ...
        <Sidebar placement="right" mobile-placement="bottom" :mobile-sticky-sidebar="true">
            ...
            <p>
                An div with <code class="text-nowrap">.uu-content</code> that should contain all
                <em>content elements</em>. This div will automatically grow to fill the page if the
                actual content is not long enough.
            </p>
            <p>An overview of <em>content elements</em>:</p>
            <h3>UU Container</h3>
            <p>
                Your main <i>content element</i> is <code>.uu-container</code>. This is a generic
                container similar to Bootstrap's <code>.row</code>, and should be used as such. It
                is recommended to use Bootstrap's <code>.col-*</code> classes inside of this element
            ...
            <div class="alert alert-warning">
                Note: using this class is admitting your interface is not responsive and thus broken
                on smaller screens. It is recommended you explore responsive options before using
