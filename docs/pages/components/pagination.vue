...
$pagination-ellipsis-color: $gray-700;
            ...
            <ul class="pagination justify-content-center" role="navigation" aria-label="pagination">
                ...
                <li
                    ...
                    :key="item"
                    class="page-item"
                    :class="(item === 'ELLIPSIS' ? 'page-ellipsis ' : '') + (item === currentPage ? 'active' : '')"
                >
                    <a
                        class="page-link"
            ...
            <p>
                To display ellipsis (the three dots), add the <code>.page-ellipsis</code> class to a
                <code>.page-item</code>. The item's content will automatically be hidden and replaced by the three dots.
            </p>
            <p>
                Please note that you still have to include an element with the <code>.page-link</code> class to make
                this work. This can be an <code>a</code> or a <code>span</code> element.
            </p>
            <h2 class="hdr-underlined">
                Pagination Button
            </h2>
            <p>
                The prev/next buttons should be decorated by a <code>.page-button</code> class. It will make it look
                pretty, but most importantly it will not force the item to be square.
            </p>
            <h3>Datatables</h3>
            <p>
                There's some custom CSS to make Datatables' buttons work correctly; if you find them, please don't use them.
            </p>
        </Sidebar>
    </div>
</template>
