    ...
    <div class="uu-content">
        ...
        <div class="uu-sidebar-container">
            ...
            <div class="uu-sidebar-content">
                <p>
                    Welcome to the official docs (/dev environment) for the DH-IT Portaldev UU
                    Bootstrap theme!
                </p>
                <p>
                ...
                <p>
                    The theme can be used as part of your larger SASS setup, or standalone by
                    including the compiled CSS.
                </p>
                <p>
                    Bootstrap 5 is included in this library (either as a dependency or bundled), you
                    don't need to import it's CSS separately. The JS side does need manual loading,
                    more info down below.
                </p>
                <h3 class="hdr-underlined">CSS</h3>
                <h4 class="hdr-underlined">Using SASS (recommended)</h4>
                <p>Using SASS is recommended for easily extending and overriding variables.</p>
                <p>
                    Add the library using yarn, replacing
                    <code>&lt;tag&gt;</code> with the latest release tag. (Or leave out the tag to
                    track develop)
                </p>
...
@import "node_modules/uu-bootstrap/scss/bootstrap";</code></pre>
                ...
                <p>
                    If you can't use SASS, you can simply include the compiled versions in
                    <code>/dist/css/bootstrap(.min).css</code>
                </p>
                ...
                <p>
                    The Bootstrap javascript files aren't bundled with this project. You'll either
                    have to retrieve them from
                    <code>node_modules</code> (if using sass/yarn), or download them from
                    Bootstrap's website.
                </p>
            </div>
        </div>
